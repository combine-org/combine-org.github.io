...
conf_location: Humboldt University of Berlin, Philippstraße 13, House 4, Berlin (In Person)
...
**Thus 6th & Fri 7th Oct**, 8:30am-6pm at [Humboldt University of Berlin, Philippstraße 13, House 4](https://goo.gl/maps/fkXSerwGRWSFUPSC9)
...
COMBINE community (see Topics of Interest below). The link to submit suggestions for breakout sessions or tutorials is
 [here](https://forms.gle/4VHZTxR5FcY2GLhR8).

<h3>COMBINE Forum</h3>

**Single track session with invited and submitted talks**

**Sat 8th Oct**, 8am-1pm at [Humboldt University of Berlin, Philippstraße 13, House 4](https://goo.gl/maps/fkXSerwGRWSFUPSC9)


<h1>How to get there?</h1>

COMBINE2022 is located at [Humboldt University of Berlin, Philippstraße 13, House 4](https://goo.gl/maps/fkXSerwGRWSFUPSC9)
...
<img src="/images/combine2022/COMBINE2022_plan.png" alt="demo" class="img-responsive">
...
| 9am | <i>Breakouts & Tutorials 1</i> <br/> **Breakouts**: <br/> - Room 1 (House 4, Lecture Hall): SEP 55 (Prashant Vaidyanathan) <br/> - Room 2 (House 4, 012a): SED-ML Level 2: Proposals and Requirements (Lucian Smith) |
| 10:30am | <i>Break / Coffee</i> |
| 11am | <i>Breakouts & Tutorials 2</i> <br/>**Tutorial**:<br/> - Room 3 (House 18, Maut Menten): CovidGraph: Interfaces and Usage <br/> **Breakouts**: <br/> - Room 1 (House 4, Lecture Hall): Parametric SVG for SBOL Visual (Thomas Gorochowski) <br/> - Room 2 (House 4, 012a): SED-ML Level 2: Proposals and Requirements |
| 12:30pm | <i>Lunch</i> (self organized) |
| 2pm | <i>Breakouts & Tutorials 3</i><br/>**Tutorial**: <br/> - Room 4 (House 20, Seminar Room): Clinical trial simulations with the Jinkō modeling platform <br/> **Breakouts**: <br/> - Room 1 (House 4, Lecture hall): SBOL 3.1 (Gonzalo Vidal)<br/> - Room 2 (House 4, 012a): Curating models and simulations for BioSimulations (David Nickerson)<br/> - Room 3 (House 18, Maud Menten): Protocol Activity Modeling Language Standard Working Group (Daniel Bryce) |
| 3:30pm | <i>Break / Coffee</i> |
| 4pm | <i>Breakouts & Tutorials 4</i> <br/>**Breakouts**: <br/> - Room 1 (House 4, Lecture Hall): Representation of Site-Variant Libraries (James Diggans) <br/> - Room 2 (House 4, 012a): VSCode-Antimony: A Smart Editor for Developing Models in Systems Biology (Joe Hellerstein/Herbert Sauro) <br/> - Room 3 (House 18, Maut Menten): Protocol Activity Modeling Language Standard Working Group |
...
|:---|:---|
| 8:30am | <i>Welcome</i> (Matthias König, House 4, Lecture Hall) |
| 9am | <i>Breakouts & Tutorials 5</i> <br/>**Tutorial:**<br/> - Room 3 (House 18, Seminar Room): Morpheus: Multi-scale, Multi-cellular, Spatio-temporal Modeling with Hands-on for Your Own Projects <br/> **Breakouts**: <br/> - Room 1 (House 4, Lecture Hall): Managing RDF Packages (Jacob Beal) <br/> - Room 2 (House 4, 012a): FROG Analysis - a community standard to foster reproducibility and curation of constraint-based models (Rahuman Sheriff) <br/> - Room 4 (House 20, Seminar Room): Similarity Computation of Small Molecule Names (Lukrécia Mertová) |
| 10:30am | <i>Break / Coffee</i> |
| 11am | <b><i>Breakouts & Tutorials 6</i></b><br/> **Breakouts**: <br/> - Room 1 (House 4, Lecture Hall): SBOL Examples (Prashant Vaidyanathan) <br/> - Room 2 (House 4, 012a): FAIRness assessment of COMBINE archives (Irina Balaur, Dagmar Waltemath) <br/> - Room 3 (House 18, Seminar Room): MultiCellML -- a "to-be" Multi-cellular Modelling language (Jörn Starruß)<br/> - Room 4 (House 20, Seminar Room): SBML FBC Package Finalization (Matthias König) |
| 12:30pm | <i>Lunch</i> (self organized) |
| 2pm | <b><i>Breakouts & Tutorials 7</i></b> <br/>**Tutorial**: <br/> - Room 4 (TBA): Creating reproducible biochemical modeling workflows in Python (Part 1) <br/> **Breakouts**: <br/> - Room 1 (House 4, Lecture Hall): RNA Working Group Discussions (Thomas Gorochowski) <br/> - Room 2 (TBA): FAIRness assessment of COMBINE archives <br/> - Room 3 (TBA): MultiCellML -- a "to-be" Multi-cellular Modelling language (Jörn Starruß) <br/> - Room 5 (TBA): Protocol Activity Modeling Language Standard Working Group (Daniel Bryce) |
| 3:30pm | <i>Break / Coffee</i> |
| 4pm | <b><i>Breakouts & Tutorials 8</i></b> <br/>**Tutorial**:<br/> - Room 4 (TBA): Creating reproducible biochemical modeling workflows in Python (Part 2) <br/> **Breakouts**: <br/> - Room 1 (TBA): RNA Working Group Discussions <br/> - Room 2 (TBA): "Data Hazards: framework for thinking ethics in computational systems biology (Susana Roman Garcia)" <br/> - Room 3 (TBA): SBGN general discussion (Adrien Rougny) <br/> - Room 5 (TBA): Protocol Activity Modeling Language Standard Working Group (Daniel Bryce) |
| 5:30pm | Wrap-up (House 4, Lecture Hall) |
